...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        Address address4 = new Address("", null, null, null, "1");
        Map<String, List<String>> result4 = Validator.advancedValidate(address4);
        Map<String, List<String>> expected4 = new HashMap<>();
        expected4.put("city", List.of("can not be null", "length less than 3"));
        expected4.put("street", List.of("can not be null", "length less than 2"));
        expected4.put("houseNumber", List.of("can not be null"));
