...
public class UsersServlet extends HttpServlet {
    ...
    private void createUser(HttpServletRequest request,
        ...
        Map<String, String> user = buildUser(getNextId(), firstName, lastName, email);
    ...
    private Map<String, String> buildUser(String id, String firstName, String lastName, String email) {
    ...
    private void updateUser(HttpServletRequest request,
        ...
        if (!isValid(firstName,lastName, email)) {
            request.setAttribute("user", buildUser(id, firstName, lastName, email));
        ...
        users = users.stream().map(u -> {
            ...
            Map<String, String> updated = new HashMap<>(user);
